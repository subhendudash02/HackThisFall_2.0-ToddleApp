...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<String> videoTitles = [
    "🚀 Opening Ceremony | Hack This Fall 2.0 🐿️",
    "📁 Deploy using Filebase's S3 Compatible API | 🗣️ Zac Cohen | 🐿️ Hack This Fall 2.0",
    "☁️ Move your local dev env to the cloud | 🗣️ Pauline Narvas | 🐿️ Hack This Fall 2.0",
    "🤓 Using GitHub to win hackathons | 🗣️ Eddie Jaoude | 🐿️ Hack This Fall 2.0",
    "💖 Unleashing the Power of Communities | 🗣️ Khushboo Verma | 🐿️ Hack This Fall 2.0"
  ];

  Channel channel =
      new Channel("HackThisFall", AssetImage("assets/profilepics/5.jpg"));
